...
const STRINGS = {
  en: {
    ...
    stepEnv: 'Environment',
    stepChars: 'Characters',
    envQ: 'Want to see the environment first?',
    envSub: 'A still of the setting only, no characters. Costs about one preview. Not sure? Skip it with Continue.',
    charQ: 'Want to see your characters?',
    charSub: 'A reference sheet per character: front, back and side views on a white background. Preview one, then the others, or skip.',
    previewAgain: 'Preview again',
    continueToEnv: 'Next: environment',
    continueToGenerate: 'Next: generate',
    backToPreviews: 'Back to previews',
    whichScene: 'Which scene to generate',
    sceneN: 'Scene {n}',
    generateThisScene: 'Generate scene {n}',
  ...
  ar: {
    ...
    stepEnv: 'البيئة',
    stepChars: 'الشخصيات',
    envQ: 'هل تريد رؤية البيئة أولًا؟',
    envSub: 'صورة للمكان فقط دون شخصيات، بتكلفة معاينة واحدة تقريبًا. غير متأكد؟ تخطَّها بزر «متابعة».',
    charQ: 'هل تريد رؤية شخصياتك؟',
    charSub: 'ورقة مرجعية لكل شخصية: مناظر أمامية وخلفية وجانبية على خلفية بيضاء. عاين واحدة ثم البقية، أو تخطَّ.',
    previewAgain: 'معاينة مجددًا',
    continueToEnv: 'التالي: البيئة',
    continueToGenerate: 'التالي: الإنتاج',
    backToPreviews: 'العودة إلى المعاينات',
    whichScene: 'أي مشهد تريد إنتاجه',
    sceneN: 'المشهد {n}',
    generateThisScene: 'إنتاج المشهد {n}',
